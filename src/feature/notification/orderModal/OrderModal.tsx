...
const OrderModal = ({
    ...
    scopeOfWork: string;
    location: string;
    reviewedUserId: string, projectId: string
    ...
    return (
        <div className='overflow-hidden'>
            {modalState === "infoModal" && (
                <ModalTransition>
                    <InfoModal actions={actions} samplePost={samplePost} setModalState={setModalState} />
                </ModalTransition>
            )}
            ...
            {modalState === "confirmOrder" && (
                <ModalTransition>
                    <ConfirmModal handleCreteReview={handleCreteReview} projectId={projectId} reviewedUserId={reviewedUserId} samplePost={samplePost} setModalState={setModalState} />
                </ModalTransition>
            )}
        </div>
    );
