...
export const InfoModal = ({ setModalState, samplePost, actions }: { setModalState: React.Dispatch<React.SetStateAction<string>>, samplePost: any, actions: "cancel" | "confirm" | "infoModal" }) => {
