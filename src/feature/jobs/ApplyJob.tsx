        ...
        if (images) {
            ...
            try {
                const applicationData = {
                    jobId: id as string, // You need to get this from props or context
                    name: formData.name,
                ...
                // Show error toast
                const errorMessage = error.data?.message || "Failed to submit application";
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className={`w-full px-3 py-2 border ${errors.coverLetter ? "border-red-500" : "border-gray-300"
                            } rounded-md focus:outline-none focus:ring-1 focus:ring-primary`}
                    />
                    {errors.coverLetter && (
                ...
                <div className="flex justify-end gap-4 pt-4">
                    ...
                    <PrimaryButton onClick={() => { }} text="Apply Now" loading={isLoading} />
                </div>
            </form>
        </div>
    );
